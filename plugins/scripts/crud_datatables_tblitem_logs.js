...
//! Datatables
    ...
    var dataTable =  $('#mainTable').DataTable({
        "ajax": "../controller/controller_fetch_tblitem_logs.php",
        "type": "POST",
        "select": true,
        "rowId": 'id',
        "responsive": true, 
     ...
     $('.borrowerSelect').change(function () {
      ...
      $('.cnSelect').change(function () {
          dataTable.column(5).search(this.value).draw();
      });

      $('.itemStatusSelect').change(function () {
          dataTable.column(10).search(this.value).draw();
      });

      $('.returnStatusSelect').change(function () {
          dataTable.column(11).search(this.value).draw();
      });
