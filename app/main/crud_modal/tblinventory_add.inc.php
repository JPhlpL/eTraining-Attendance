<div class="modal fade" id="add-modal" aria-hidden="true">
  <div class="modal-dialog modal-lg">
      ...
      <div class="modal-header">
        <h4 class="modal-title" id="userCrudModal"> Add Item </h4>
              ...
              <form id="add-form" name="add-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" id="IT_ITEM_PHOTO" name="IT_ITEM_PHOTO" class="custom-file-input" onchange="previewItemPhoto()">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="datetime-local" class="form-control" id="IT_ITEM_FIRSTCLAIM_DATETIME" name="IT_ITEM_FIRSTCLAIM_DATETIME" value=""  >
                    </div>
                </div>
