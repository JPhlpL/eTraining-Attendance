                    ...
                    <form id="update-form" name="update-form" class="form-horizontal" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="id" id="id">
                        ...
                        <div class="form-group">
                            <label for="name" class="control-label">Competency Skill</label>
                            <div class="col-sm-12">
                                <input type="name" class="form-control" id="EMPLOYEE_COMP_SKILL" name="EMPLOYEE_COMP_SKILL" value="" required>
                            </div>
                        </div>
