        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <div class="form-group">  
                        ...
                        <!-- Hide -->
                        <!-- For Adding -->
                        <form name="add_compskill" id="add_compskill" enctype="multipart/form-data">  
                                ...
                                <table class="table table-head-fixed table-hover text-nowrap" id="autocomplete_table">  
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="bg-dark text-white">Competency Skill/s</th>
                                    ...
                                    <tbody>
                                        <tr id="row_1"> 
                                            <td></td>
                                            <td><textarea required name="EMPLOYEE_COMP_SKILL[]" id="EMPLOYEE_COMP_SKILL_1" class="form-control autocomplete_txt" autocomplete="off" cols="70" rows="2"></textarea></td>
                            ...
                            <input type="submit" name="compskillBtn" id="compskillBtn" class="btn btn-info" value="Submit" hidden/>  
                        </form>  
                    </div> 
            </div>
        </div><!-- /.row -->
...
<?php include '../crud_modal/tblemplist_comp_skill_edit.inc.php'; ?>
