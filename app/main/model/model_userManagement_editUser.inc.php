        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <form name="add_user" id="add_user" enctype="multipart/form-data" method="post">

                        <input type="hidden" name="param" id="param">
                        <input type="hidden" class="form-control" id="mode" name="mode" value="update">
                        <input type="hidden" class="form-control" id="USER_PHOTO" name="USER_PHOTO" value="">
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group rounded">
                                    <!-- <a class='text-dark' href='' data-toggle='lightbox' data-title=''> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="USER_PASS" name="USER_PASS" value="" maxlength="50">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <a id="usertip" class="control-label text-dark" data-toggle="tooltip" data-placement="top" data-html="true" title="Super Admin, Admin, Approver, Checker, User">
...
<?php include '../crud_modal/usertip.modal.inc.php'; ?>