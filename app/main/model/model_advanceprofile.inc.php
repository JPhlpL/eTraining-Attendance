...
<section class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3">
        <!-- For Side info content --> <?php include '../../includes/sideinfo_content.inc.php'; ?>
        <!-- /.card -->
      </div>
      <!-- /.col -->
      <div class="col-md-9">
        <div class="card">
          <!-- For Card Header --> <?php include '../../includes/card_header.inc.php';?> 
          <div class="card-body">
              ...
              <div class="active tab-pane">
                <div class="card card-secondary collapsed-card ">
                    <div class="card-header">
                        <form id="insert_empinfo" name="insert_empinfo" enctype="multipart/form-data" method="post">

                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                            <i class="fas fa-plus"></i> Approval Table History
                        </button>
                        <!-- Create display in table inside aproval table history -->

                        <button type="button" id="btn-update" class="border border-transparent text-white bg-secondary rounded">
                    ...
                    <div class="card-body">
                    <!-- Table -->
                      <table class="table table-head-fixed table-hover text-nowrap" id="approvalinfotbl">
                        <thead>
                          <tr class="text-center">
                            <th class="bg-dark text-white"></th>
                            <th class="bg-dark text-white"> EMPLOYEE ID </th>
                            <th class="bg-dark text-white"> EMPLOYEE NAME </th>
                            <th class="bg-dark text-white"> EMPLOYEE EMAIL </th>
                            <th class="bg-dark text-white"> EMPLOYEE MOBILE NUM </th>
                            <th class="bg-dark text-white"> EMPLOYEE AGE </th>
                            <th class="bg-dark text-white"> EMPLOYEE GENDER </th>
                            <th class="bg-dark text-white"> EMPLOYEE DEPT </th>
                            <th class="bg-dark text-white"> EMPLOYEE SECTION </th>
                            <th class="bg-dark text-white"> EMPLOYEE POSITION </th>
                            <th class="bg-dark text-white"> EMPLOYEE JOB LEVEL </th>
                            <th class="bg-dark text-white"> EMPLOYEE STATUS </th>
                            <th class="bg-dark text-white"> EMPLOYEE DATE HIRED </th>
                            <th class="bg-dark text-white"> EMPLOYEE QR </th>
                            <th class="bg-dark text-white"> EMPLOYEE RFID </th>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" id="mode" name="mode" value="addinfo">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          <select id='EMPLOYEE_GENDER' name="EMPLOYEE_GENDER" class="form-control form-control" disabled> <?php 
                                                    ...
                                                    echo "<option value='". $row['GENDER'] ."'>" .$row['GENDER'] ."</option>" ;}?> </select>
                        </div>
                      </div>
                    </div>
                  </div>
