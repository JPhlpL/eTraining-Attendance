...
$columns = array( 
    ...
    array('db' => 'comp.EMPLOYEE_COMP_SKILL', 'dt' => 1, 'field' => 'EMPLOYEE_COMP_SKILL'),
    array( 
        'db'        => 'comp.id',
        'dt'        => 2, 
        'field' => 'id',
...
$joinQuery = "FROM tblemplist_comp_skill AS comp LEFT JOIN tblemplist_main AS main ON (comp.EMPLOYEE_HASHED = main.EMPLOYEE_HASHED)";
$extraWhere = "comp.EMPLOYEE_HASHED = '".$_SESSION['param_url']."'"; //<-- Dapat Makuha yung parameter sa taas ng screen
$groupBy = "";
$having = "";
