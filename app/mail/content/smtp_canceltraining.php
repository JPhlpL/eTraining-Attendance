...
$mail->Subject = "[CANCELLED TRAINING] GENBA Internal Training: ".$name." Training"; // Subject
                                      ...
                                      <div style="font-family: sans-serif">
                                        ...
                                        >
                                          <p
                                            ...
                                            "
                                          >
                                            Please be informed that the '.$name.' Training
                                            will be cancelled. 
                                          </p>
                                          <p
                                            style="
                                      ...
                                      <div style="font-family: sans-serif">
                                        ...
                                        >
                                          <p
                                            ...
                                            "
                                          >
                                            Please Click <a  href="http://'.$ip_address.'/DNPH/_eTrainingAttendance/app/public/view/login.php"  >here</a> to login.
                                          </p>
                                          <p
                                            style="
                                              margin: 0;
